...
export class DashboardPageComponent implements OnInit, OnDestroy {
  ...
  // Use definite assignment assertion for the subscription
  ...
  calculateScaleFactor(): void {
    // Assume available height is window height minus header (60px) and footer (40px).
    // And available width is window width minus sidebar width (220px).
